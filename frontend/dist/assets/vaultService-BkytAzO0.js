...
import { n as B, o as L, l as z, r as y, b as K, p as m, u as W, s as Q, g as Z, q as O, a as N, __tla as __tla_1 } from "./index-DZYvMiSj.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: r } = await D(async ()=>{
                    const { useLayoutStore: o } = await import("./index-DZYvMiSj.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.y);
                    return {
    ...
    $ = async (t)=>{
        if (t && t.secret && !t.secret.startsWith("nodeauth:")) {
            const { useAppLockStore: r } = await D(async ()=>{
                const { useAppLockStore: s } = await import("./index-DZYvMiSj.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.D);
                return {
            ...
            if (n) {
                const { maskSecretFront: s } = await D(async ()=>{
                    const { maskSecretFront: o } = await import("./index-DZYvMiSj.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((i)=>i.C);
                    return {
                        ...
                        if (!p?.success) {
                            ...
                            if (T) {
                                ...
                                const { useOfflineStore: S } = await D(async ()=>{
                                    const { useOfflineStore: g } = await import("./index-DZYvMiSj.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((b)=>b.z);
                                    return {
